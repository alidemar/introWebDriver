...
public class SearchMovieParentTest {
    ...
    public static void buscarPelicula(String pelicula) {
        ...
        if (wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//div[contains(@class, 'imdb-header__search-menu')]"))).isDisplayed())
    ...
    public static void validarBusqueda(String pelicula) {
        WebElement headerResult = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//h1[@class='findHeader']")));
